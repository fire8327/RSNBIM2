                    ...
                    <div class="flex flex-col gap-4 md:gap-7 xl:gap-5 w-full">
                        ...
                        <div class="md:max-w-[454px] xl:max-w-[564px] max-sm:mt-10 rounded-[12px] md:rounded-[30px] flex items-center gap-1 md:gap-3 xl:gap-5 w-fit md:w-full bg-gradient-to-b from-[#136BFB] to-[#6E99E1] text-white py-1 md:py-1.5 xl:py-2.5 px-2 md:px-5 xl:px-6">
                            ...
                            <div class="flex flex-col gap-0.5 md:gap-2">
                                <p class="text-[14px] md:text-[21px] leading-[115%] font-semibold">Revit Server под вашим брендом</p>
                                <p class="text-[12px] md:text-[15px] leading-[130%]">чтобы работа в Revit Server стала частью корпоративной экосистемы.</p> 
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col gap-4 md:gap-7 xl:gap-11 xl:max-w-[564px]">
                        <div class="flex flex-col gap-2 md:gap-4 xl:gap-5">
                            <div class="flex items-start gap-2 md:gap-3.5">
                                ...
                                <div>
                                    <p class="text-[14px] md:text-[21px] leading-[100%] font-semibold">Работайте с Revit Server под вашим брендом</p>
                                    <p class="text-[12px] md:text-[15px] leading-[150%]">Вы можете использовать не только домен rsnbim.ru, но и собственный — например, yourcompany.ru. Это позволит вашим сотрудникам подключаться к проектам через привычный корпоративный адрес и подчеркнёт профессиональный имидж компании.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-2 md:gap-3.5">
                                ...
                                <div>
                                    <p class="text-[14px] md:text-[21px] leading-[100%] font-semibold">Корпоративный домен</p>
                                    <p class="text-[12px] md:text-[15px] leading-[150%]">Подключение собственного домена помогает сохранить единый стиль и структуру вашей IT-инфраструктуры. Вместо стандартного адреса вы можете использовать, например:</p>
                            ...
                            <div class="flex items-start gap-2 md:gap-3.5">
                                ...
                                <div>
                                    <p class="text-[14px] md:text-[21px] leading-[100%] font-semibold">Несколько серверов — один бренд</p>
                                    <p class="text-[12px] md:text-[15px] leading-[150%]">Объедините ваши Revit-серверы под корпоративным именем и управляйте проектами централизованно. Такое решение не только повышает узнаваемость бренда, но и делает внутренние процессы более удобными и прозрачными для всей команды.</p>
                                </div>
                            </div>
                        </div>
                    </div>
