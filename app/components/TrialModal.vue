            ...
            <div class="flex items-center max-xl:flex-col gap-5 md:gap-14 xl:gap-12">
                <div class="flex flex-col gap-5 md:gap-14 xl:gap-10 w-full">
                    <div class="flex flex-col gap-4 md:gap-7 xl:gap-5 w-full">
                        <p class="max-sm:max-w-[179px] md:max-w-[590px] w-full xl:max-w-full text-[20px] md:text-[40px] leading-[130%] font-medium">Попробуйте сервис RSNBIM бесплатно!</p>
                        <div class="md:max-w-[454px] xl:max-w-[564px] max-sm:mt-10 rounded-[12px] md:rounded-[30px] flex items-center gap-1 md:gap-3 xl:gap-5 w-fit md:w-full bg-gradient-to-b from-[#136BFB] to-[#6E99E1] text-white py-1 md:py-1.5 xl:py-2.5 px-2 md:px-5 xl:px-6">
                            <img src="/images/modals/calendar.svg" alt="" class="w-7 md:w-[71px] xl:w-[87px]">
                    ...
                    <div class="flex flex-col gap-4 md:gap-7 xl:gap-11 xl:max-w-[564px]">
                        ...
                        <div class="flex items-start md:items-center gap-1 md:gap-4 bg-[#D8E4F9] py-1 px-1 md:py-3.5 md:px-4 xl:px-5 xl:py-4 rounded-[10px] md:rounded-[18px]">
                            <img src="/images/modals/clock.svg" alt="" class="w-8 md:w-[50px]">
                ...
                <img src="/images/modals/hero_modal.png" alt="" class="w-[88px] md:w-[204px] xl:w-[273px] absolute top-5 right-2.5 md:top-[34px] md:right-16 xl:right-[110px] xl:top-1/2 xl:-translate-y-1/2">
            </div>
